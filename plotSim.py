...
numReps=20
selectOn=False
plot2alleleSim(popSize,numGen,numReps,selectOn)
...
numReps=20
selectOn=False
plotMutationSim(startAllele,popSize,numGen,mutProb,numReps,selectOn,fitnessD,'blue')
pyplot.ylim((0,1))
pyplot.xlabel("Generations")
pyplot.show() 
...
pyplot.subplot(2, 1, 1)
plot2alleleSim(150,40,20,True)
pyplot.title("Popsize 150")
pyplot.subplot(2, 1, 2)
plot2alleleSim(1000,40,20,True)
pyplot.title("Popsize 1000")
pyplot.xlabel("Generation")
pyplot.show() 

plot2alleleSim(20,200,10,False)
pyplot.show()

numGen=120
mutProb=0.002
numReps=300
plotMutationSim('ACG',10,numGen,mutProb,numReps,False,{},'blue')
plotMutationSim('ACG',20,numGen,mutProb,numReps,False,{},'black')
plotMutationSim('ACG',40,numGen,mutProb,numReps,False,{},'red')
pyplot.xlabel("Generation")
pyplot.title("Population size vs. heterozygosity")
pyplot.show() 
...
mutProb=0.002
numReps=300
plotMutationSim('ACG',popSize,numGen,mutProb,numReps,False,{},'blue')
plotMutationSim('ACG',popSize,numGen,mutProb,numReps,True,fitnessD,'green')
pyplot.xlabel("Generation")
pyplot.title("Selection and heterozygosity")
pyplot.show() 